...
import { FakeFragment, FakeTemplateElement, FakeHTMLElement, setupGlobals } from '../test-utils/shared-test-helpers.js';

setupGlobals();

const { KataButtonElement } = await import('./kata-button.js');
